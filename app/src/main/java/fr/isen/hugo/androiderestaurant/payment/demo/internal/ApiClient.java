...
*/
    ...
    @FormUrlEncoded
    @POST("/checkout.php")
    void createTransaction(@Field("amount") String amount, @Field("nonce") String nonce, Callback<Transaction> callback);

    @FormUrlEncoded
    @POST("/checkout.php")
    void createTransaction(@Field("amount") String amount, @Field("nonce") String nonce, @Field("merchant_account_id") String merchantAccountId, Callback<Transaction> callback);

    @FormUrlEncoded
    @POST("/checkout.php")
    void createTransaction(@Field("amount") String amount, @Field("nonce") String nonce, @Field("merchant_account_id") String merchantAccountId, @Field("three_d_secure_required") boolean requireThreeDSecure, Callback<Transaction> callback);
}
